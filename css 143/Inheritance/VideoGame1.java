...
public class VideoGame1 extends JFrame implements KeyListener, ActionListener  {
    ...
    public VideoGame1()
    {
        ...
        // Circle s1 = new Circle(randX(), randY(), 50, Color.RED);
        // Circle s2 = new Circle(randX(), randY(), 50, Color.GREEN);
        // Circle s3 = new Circle(randX(), randY(), 50, Color.ORANGE);
        // Circle s4 = new Circle(randX(), randY(), 50, Color.MAGENTA);

        // Rectangle s1 = new Rectangle(randX(), randY(), 75, 50, Color.RED);
        // Rectangle s2 = new Rectangle(randX(), randY(), 75, 50, Color.GREEN);
        // Rectangle s3 = new Rectangle(randX(), randY(), 75, 50, Color.ORANGE);
        // Rectangle s4 = new Rectangle(randX(), randY(), 75, 50, Color.MAGENTA);

        // Pentagon s1 = new Pentagon(randX(), randY(), 50, Color.RED);
        // Pentagon s2 = new Pentagon(randX(), randY(), 50, Color.GREEN);
        // Pentagon s3 = new Pentagon(randX(), randY(), 50, Color.ORANGE);
        // Pentagon s4 = new Pentagon(randX(), randY(), 50, Color.MAGENTA);

        // Triangle s1 = new Triangle(randX(), randY(), 50, Color.RED);
        // Triangle s2 = new Triangle(randX(), randY(), 50, Color.GREEN);
        // Triangle s3 = new Triangle(randX(), randY(), 50, Color.ORANGE);
        // Triangle s4 = new Triangle(randX(), randY(), 50, Color.MAGENTA);
    ...
    // public static void runAllTests(VideoGame1 v) {
    //     System.out.print("Getting area for: " + v.shapeList[0].getClass() + " ");
    //     for (Shape var : v.shapeList) {
    //         System.out.print(var.getArea() + ", ");
    //     }
