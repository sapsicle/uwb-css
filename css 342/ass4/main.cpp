/*
main.cpp
This code file is test runs the "skip list". 
...
The implementation provided here tests two classes: SNode and SkipList.

@author Modified by Neha Nehru & Andrew Coop
